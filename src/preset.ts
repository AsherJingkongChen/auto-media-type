...
export namespace Preset {
   ...
   */
  export const extensionToMediaTypes = Object.freeze<Record<string, string[]>>({
    apk: ['application/zip'],
   ...
   */
  export const mediaTypeAndMagicNumbersList = Object.freeze<
    [string, number, ...number[]][]
  >([
   ...
   */
  export const indexRanges = Object.freeze<[number, number][]>([[0, 5]]);
 ...
 */
{
  ...
  // console.assert(
  //   new Set(
  //     Preset.mediaTypeAndMagicNumbersList.map(
  //       ([type]) => type,
  //     ),
  //   ).size === Preset.mediaTypeAndMagicNumbersList.length,
  //   'Media types should not have duplicates',
  // );

  // `indexRanges`
  console.assert(
    (() => {
      for (let index = 1; index < Preset.indexRanges.length; index++) {
        const [[i0, i1], [i2, i3]] = [
          Preset.indexRanges[index - 1]!,
          Preset.indexRanges[index]!,
        ];
