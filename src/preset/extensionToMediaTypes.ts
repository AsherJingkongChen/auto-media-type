...
export const extensionToMediaTypes: Record<string, string[]> = {
  ...
  avif: [
    'image/avif',
  ] /** AVIF: https://aomediacodec.github.io/av1-avif/#brands-overview */,
  ...
  dtd: [
    'application/xml-dtd',
  ] /** DTD: https://datatracker.ietf.org/doc/html/rfc7303#section-9.5 */,
  gz: [
    'application/gzip',
  ] /** GZIP: https://www.gnu.org/software/gzip/manual/gzip.html */,
  ico: [
    'image/vnd.microsoft.icon',
  ] /** ICO: https://www.iana.org/assignments/media-types/image/vnd.microsoft.icon */,
  jar: [
    'application/java-archive',
    'application/zip',
  ] /** .zip, JAR: https://www.iana.org/assignments/media-types/application/java-archive */,
  jpe: ['image/jpeg'] /** .jpeg */,
  ...
  html: [
    'text/html',
  ] /** HTML: https://datatracker.ietf.org/doc/html/rfc2854#section-2 */,
  m2v: [
    'video/mpeg',
  ] /** MPEG-2 Video Only: https://svn.apache.org/repos/asf/httpd/httpd/trunk/docs/conf/mime.types */,
  mp1: [
    'audio/mpeg',
  ] /** MPEG-1/2 Part 3 Layer I: https://datatracker.ietf.org/doc/html/rfc3003#section-2 */,
  mp2: [
    'audio/mpeg',
  ] /** MPEG-1/2 Part 3 Layer II: https://datatracker.ietf.org/doc/html/rfc3003#section-2 */,
  mp3: [
    'audio/mpeg',
  ] /** MPEG-1/2 Part 3 Layer III: https://datatracker.ietf.org/doc/html/rfc3003#section-2 */,
  mp4: [
    'video/mp4',
  ] /** MPEG-4 Part 14: https://datatracker.ietf.org/doc/html/rfc4337#section-3.1 */,
  mpeg: [
    'video/mpeg',
  ] /** MPEG-1/2 Part 2: https://www.loc.gov/preservation/digital/formats/fdd/fdd000028.shtml */,
  mpg: ['video/mpeg'] /** .mpeg */,
  mpg4: ['video/mp4'] /** .mp4 */,
  ...
  otf: [
    'font/otf',
    'font/ttf',
  ] /** OpenType/TrueType Font: https://datatracker.ietf.org/doc/html/rfc8081#section-4.4.3 */,
  pdf: [
    'application/pdf',
  ] /** PDF: https://datatracker.ietf.org/doc/html/rfc8118#section-8 */,
  png: [
    'image/png',
    'image/apng',
  ...
  ttf: [
    'font/ttf',
  ] /** TrueType Font: https://datatracker.ietf.org/doc/html/rfc8081#section-4.4.2 */,
  ...
  xml: [
    'application/xml',
  ] /** https://datatracker.ietf.org/doc/html/rfc7303#section-9.1 */,
  ...
  zip: [
    'application/zip',
  ] /** ZIP: https://pkware.cachefly.net/webdocs/APPNOTE/APPNOTE-6.3.10.TXT */,
