...
import { KeyedSparseArrayCollection, SparseArray } from '../core';
import { SupportedMediaTypes } from './supportedMediaTypes';

/**
 * ## Introduction
 * A keyed sparse array collection of media type and magic bytes
 *
 * ## Layout
 ...
 */
export const mediaTypeAndMagicBytes: KeyedSparseArrayCollection = [
...
/**
 * ## Introduction
 * A keyed sparse array collection of media type and magic masked bytes
 *
 * ## Layout
 * `KeyedSparseArrayCollection`
 * - The key is a media type
 ...
 * - [Wikipedia - List of file signatures](https://en.wikipedia.org/wiki/List_of_file_signatures)
 */
export const mediaTypeAndMagicMaskedBytes: KeyedSparseArrayCollection = [
