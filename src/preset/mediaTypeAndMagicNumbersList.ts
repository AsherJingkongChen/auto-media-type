...
export const mediaTypeAndMagicNumbersList: [
  ...
  ['application/xml-dtd', undefined, 0, 0x3c, 0x21], // `<!` (XML Declaration Prefix): https://datatracker.ietf.org/doc/html/rfc7303#section-9.5
  ...
  ['text/html', undefined, 0, 0x3c, 0x21, 0x44, 0x4f], // `<!DO` (HTML Preamble): https://datatracker.ietf.org/doc/html/rfc2854#section-5, https://html.spec.whatwg.org/#the-doctype
  ['text/html', undefined, 0, 0x3c, 0x21, 0x64, 0x6f], // `<!do` (HTML Preamble): https://datatracker.ietf.org/doc/html/rfc2854#section-5
  ['text/html', undefined, 0, 0x3c, 0x68, 0x74, 0x6d, 0x6c, 0x3e], // `<html>` (HTML Root): https://datatracker.ietf.org/doc/html/rfc2854#section-5
